...
def get_id_trainer(token: str = Depends(JWTBearer())):
    """Get the id of the trainer from the token"""
...
def add_training(request: Request, request_body: TrainingRequestPost, id_trainer : ObjectIdPydantic = Depends(get_id_trainer)):
